				...
				<table border="0" cellspacing="1" width="100%" align="center">
					...
					<tr>
						<td colspan="5" align="right" valign="middle" height="20"><font
							size="2" face="고딕">전체 : ${list.size() }</b>건 - 3 Pages
						</font></td>
					</tr>
					<tr bgcolor="e3e9ff">
					...
					<c:forEach var="guest" items="${list }">
						<tr onMouseOver="style.backgroundColor='#D1EEEE'"
							...
							<td align="center" height="25"><font face="돋움" size="2"
								color="#000000">${guest.idx }</font></td>
							<td align="left" height="20"><font face="돋움" size="2"
								color="#000000"> ${guest.subject }</td>
							<td align="center" height="20"><font face="돋움" size="2">
									<a class="list" href="">${guest.name }</a>
							</font></td>
					...
					<div align="center">
						<table width="700" border="0" cellspacing="0" cellpadding="5">
							...
							<tr align=right>
								<td colspan="5"><a href="guest_write"><img
